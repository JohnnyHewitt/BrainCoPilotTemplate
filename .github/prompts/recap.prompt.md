---
mode: 'chat'
description: 'Project recap — re-establish context after a break'
---
...
2. **Project Context**
   - Read `AGENTS.md` for project structure and constraints
...
**Project:** {brief description from AGENTS.md}
...
> **Usage:** Run when starting a new session, after context gets long, before making significant changes, or when you've lost track of where things stand.
