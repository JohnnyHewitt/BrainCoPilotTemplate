---
mode: 'chat'
description: 'BRAIN method — scaffold a new feature with intent breakdown'
---

# BRAIN Method — Project Skeleton & Intent List
...
> **Critical:** During Begin, the AI must not analyze, summarize, suggest, or reframe.
...
> AI may update **Status** column. Human owns **Actual** column.
...
> **Usage:** In Copilot Chat, type `/brain` and select this prompt, then provide your idea title.
